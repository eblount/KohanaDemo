   ...
   if(!empty($providers)) {
      ...
      if($identities->count() > 0) {
         foreach($identities as $identity) {
            $row['identities'] .= '<img src="'.URL::site('/img/admin/tiny/'.$identity->provider.'.png').'"> ';
         }
      }
   }
   $data[] = $row;
...
$column_list = array( 'name' => array( 'label' => __('Name') ),
...
$datatable = new Helper_Datatable($column_list, array('paginator' => true, 'class' => 'table', 'sortable' => 'true', 'default_sort' => 'name'));
